...
@Composable
fun ColleaguesGroupInterface(navController: NavHostController, title: String) {
    ...
    Column(
        ...
        Column(
            ...
            Column(
                ...
                CreateZoomScreen(painterResource(id = R.drawable.colleaguesheader))

            }
            Text(
                text = "Colleague Groups",
                modifier = Modifier
                    .width(176.dp)
                    .height(22.dp),
                style = TextStyle(
                                        ...
                                        onTap = {
                                            if (selectedItems.isNotEmpty()) {
                                                ...
                                                navController.navigate(
                                                    Routes.ColleaguesGroupChatScreen.createRoute(
                                                        message.title,
                                                    )
                                                )
                                            }
