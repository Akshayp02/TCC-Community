...
@Composable
fun NeighboursGroupInterface(navController: NavHostController, title: String) {
    val headerData = HeaderData(
        painterResource(id = R.drawable.neighbours),
        title = title,
        groupInfo = "7 more people online from 12",
    ...
    Column(
        ...
        Column(
            ...
            Column(
                ...
                CreateZoomScreen(painterResource(id = R.drawable.neighbourheader))

            }
            Text(
                text = "Neighbour Groups",
                modifier = Modifier
                    .width(176.dp)
                    .height(22.dp),
                style = TextStyle(
