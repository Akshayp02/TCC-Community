...
fun BusinessChatScreen() {
    ...
    LaunchedEffect(Unit) {
        messages.add(
            GroupMassage(
                text = "next meeting is on 10th of this month",
                senderName = "Raj Sir",
                isSentByUser = false,
                imageUrls = listOf(
        ...
        messages.add(
            GroupMassage(
                ...
                senderName = "Akshay :)",
                isSentByUser = false,
                videoUrl = Uri.parse("https://www.w3schools.com/html/mov_bbb.mp4")
            )
        )
    }
    ...
    Column(
        ...
        Box(
            ...
            InputRow(
                ...
                replyingTo = replyingTo, // Passing String? value
                onCancelReply = {
                    replyingTo = null // Resetting to null
                },
                onSendMessage = {
