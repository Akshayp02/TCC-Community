...
@Composable
fun NeighboursGroupChatScreen(navController: NavHostController, title: String) {
    val headerData = HeaderData(
        painter = painterResource(id = R.drawable.neighbours),
        title = title,
        groupInfo = "7 more online from 12",
