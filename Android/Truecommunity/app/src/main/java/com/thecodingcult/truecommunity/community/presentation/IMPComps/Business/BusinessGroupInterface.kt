package com.thecodingcult.truecommunity.community.presentation.IMPComps.Business
...
@Composable
fun BusinessGroupInterface(navController: NavHostController, title: String) {
    val headerData = HeaderData(
        painterResource(id = R.drawable.businesscomunityicon),
        title = title,
        groupInfo = "2 more people online",
    ...
    Column(
        ...
        Column(
            ...
            Column(
                ...
                CreateZoomScreen(painterResource(id = R.drawable.businesshedariimg))
