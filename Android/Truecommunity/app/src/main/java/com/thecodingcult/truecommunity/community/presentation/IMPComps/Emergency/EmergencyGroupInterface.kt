package com.thecodingcult.truecommunity.community.presentation.IMPComps.Emergency
...
import com.thecodingcult.truecommunity.community.presentation.Components.EmergencyMapComponent
...
@Composable
fun EmergencyGroupInterface(navController: NavHostController, title: String) {
    val headerData = HeaderData(
        painterResource(id = R.drawable.colleagues),
        title = title,
        groupInfo = "7 more people online",
    ...
    Column(
        ...
        Column(
            ...
            Column(
                ...
                // TODO impliment map here
                EmergencyMapComponent(navController)

            }
            Text(
                text = "Emergency Groups",
                modifier = Modifier
                    .width(176.dp)
                    .height(22.dp),
                style = TextStyle(
                                        ...
                                        onTap = {
                                            if (selectedItems.isNotEmpty()) {
                                                ...
                                                navController.navigate(
                                                    Routes.EmergencyGroupChatScreen.createRoute(
                                                        message.title,
                                                    )
                                                )
                                            }
